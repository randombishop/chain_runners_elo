...
async function run() {
    ...
    var q2 = "INSERT INTO elo.rating(runner_id, rating, won, draw, lost) VALUES($1, $2, $3, $4, $5) " ;
        q2 += "ON CONFLICT(runner_id) DO UPDATE SET rating=$2, won=$3, draw=$4, lost=$5 ;" ;
    for (var id in runners) {
        var runner = runners[id] ;
        var params = [runner.runner_id, runner.rating, runner.won, runner.draw, runner.lost] ;
